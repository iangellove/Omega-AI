...
//		BGDOptimizer optimizer = new BGDOptimizer(netWork, 20000, 0.001d);
		...
		try {
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 100000, 0.00001f, 10, LearnRateUpdate.NONE);
...
//		BGDOptimizer optimizer = new BGDOptimizer(netWork, 20000, 0.001d);
		...
		try {
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 10000, 0.0001f, 64, LearnRateUpdate.NONE);
...
//		netWork.GRADIENT_CHECK = true;
		...
		try {
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 1, 0.001f, 32, LearnRateUpdate.NONE);
...
//			netWork.GRADIENT_CHECK = true;
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 10, 0.0001f, 128, LearnRateUpdate.NONE);
...
//			netWork.addLayer(bn5);
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 30, 0.001f, 64, LearnRateUpdate.NONE);
	...
	public void cnnNetwork_vgg16_cifar10() {
		...
		try {
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 2000, 0.001f, 128, LearnRateUpdate.NONE);
...
//			SoftmaxLayer softmax = new SoftmaxLayer(10);
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 20, 0.0001f, 32, LearnRateUpdate.GD_GECAY);
...
//			SoftmaxLayer softmax = new SoftmaxLayer(10);
			...
			MBSGDOptimizer optimizer = new MBSGDOptimizer(netWork, 20, 0.0001f, 32, LearnRateUpdate.NONE);
