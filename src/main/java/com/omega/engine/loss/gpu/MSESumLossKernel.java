	...
	public void initFunction() {
		...
		try {
			...
			if(loss_function == null) {
				...
				loss_function = CUDAModules.getLocalFunctionByModule("MSESumLossKernel.cu", "loss");
        
			}
			
			if(loss_backward_function == null) {
				
				loss_backward_function = CUDAModules.getLocalFunctionByModule("MSESumLossKernel.cu", "loss_back");
