	...
	public void initFunction() {
		...
		try {
			...
			if(loss_function == null) {
				...
				loss_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"BECLossKernel.cu", "loss");
        
			}
			
			if(loss_backward_function == null) {
				
				loss_backward_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"BECLossKernel.cu", "loss_back");
