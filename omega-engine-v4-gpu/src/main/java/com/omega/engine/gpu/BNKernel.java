	...
	public void initFunction() {
		...
		try {
			...
			if(mean_function == null) {
				...
				mean_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"MathKernel.cu", "mean_cov");
			...
			if(var_function == null) {
				...
				var_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"MathKernel.cu", "var_cov");
