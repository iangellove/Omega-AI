...
//	private CUfunction norm_grad_function;
	...
	public NormalizeKernel() {
		...
		norm_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"NormalizeKernel.cu", "norm");
		
//		norm_grad_function = CUDAModules.getFunctionByModule(LibPaths.LIB_PATH+"NormalizeKernel.cu", "NormalizeGradientKernel"); 
