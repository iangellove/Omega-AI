...
//	    float giou_Cw = Float.max(pred_r, truth_tblr[3]) - Float.min(pred_l, truth_tblr[2]);
//	    float giou_Ch = Float.max(pred_b, truth_tblr[1]) - Float.min(pred_t, truth_tblr[0]);
...
//	    float dC_wrt_t = pred_t < truth_tblr[0] ? (-1 * giou_Cw) : 0;
//	    float dC_wrt_b = pred_b > truth_tblr[1] ? giou_Cw : 0;
//	    float dC_wrt_l = pred_l < truth_tblr[2] ? (-1 * giou_Ch) : 0;
//	    float dC_wrt_r = pred_r > truth_tblr[3] ? giou_Ch : 0;
