...
//                    		element[j] = (bin.read() - 127.5) / 128.0;
     ...
     * @return one row show a `picture`
     */
    public static double[][] getImages(File file,boolean normalization) {
        double[][] x = null;
...
//                    		element[j] = (bin.read() - 127.5) / 128.0;
     ...
     * @return one row show a `picture`
     */
    public static double[][][][] getImagesToMatrixByBin(String fileName,int number,int channel,int height,int width,boolean normalization) {
        double[][][][] x = new double[number][channel][height][width];
    ...
    public static DataSet getImagesToDataSetByBin(String fileName,int number,int channel,int height,int width,int labelSize,boolean normalization,String[] labelSet) {
        ...
        double[][] dataLabel = new double[number][labelSize];
...
//        						x[n][c][h][w] = bin.read() / 255.0d;
    ...
    public static DataSet getImagesToDataSetByBin(String[] fileNames,int number,int channel,int height,int width,int labelSize,boolean normalization,String[] labelSet) {
    	...
    	double[][][][] x = new double[batchSize][channel][height][width];
        String[] labels = new String[batchSize];
        double[][] dataLabel = new double[batchSize][labelSize];
