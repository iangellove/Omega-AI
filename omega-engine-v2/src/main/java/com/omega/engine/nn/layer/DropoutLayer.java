...
public class DropoutLayer extends Layer {
	...
	public void initParam() {
		...
		if(this.network.RUN_MODEL == RunModel.TRAIN) {
			this.mask = MatrixUtils.val(this.number, this.oChannel, this.oHeight, this.oWidth, probability, 1.0d - probability);
		}
	...
	public void output() {
		...
		if(this.network.RUN_MODEL == RunModel.TRAIN) {
			...
			this.output.maxtir = MatrixOperation.multiplication(this.input.maxtir, 1.0d - probability);
		}
	}
